...
class ControladorVentas {
  ...
  static public function ctrEditarVenta() {
    ...
    if (isset($_POST['editarVenta'])) {
      ...
      if ($cambioProducto) {
        ...
        /* --------------------------------------------------------------------------
        End of ACTUALIZAR LAS COMPRAS DEL CLIENTE, REDUCIR EL STOCK Y AUMENTAR LAS VENTAS DE LOS PRODUCTOS
        -------------------------------------------------------------------------- */
      ...
      /* --------------- End of REVISAR SI VIENE PRODUCTOS EDITADOS --------------- */
      ...
      /* ------------------- End of GUARDAR CAMBIOS DE LA COMPRA ------------------ */
  ...
  static public function ctrEliminarVenta() {
    ...
    if (isset($_GET['idVenta'])) {
      ...
      /* ------------------ End of ACTUALIZAR FECHA ÚLTIMA COMPRA ----------------- */
